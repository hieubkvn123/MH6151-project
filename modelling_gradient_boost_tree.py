...
if __name__ == '__main__':
    ...
    model_class = hyperparams_opt.models['gradient_boost_tree']['model_class']
    hyperparams = hyperparams_opt.models['gradient_boost_tree']['hyperparams']
    ckpt_filename = hyperparams_opt.models['gradient_boost_tree']['ckpt_filename']
